...
<settings>
  <category label="30010">
    ...
    <setting id="groupNameFormat_0" type="text" label="30044" default="%s"/>
    <setting id="channelNameFormat_0" type="text" label="30045" default="%s"/>
    ...
    <setting id="logoFileNameFormat_0" type="text" label="30046" default="%s"/>
  </category>
  
  <category label="30040">
    <setting id="sourceCount" type="enum" label="30041" default="1" values="@SOURCES@"/>'
SOURCE_SETTINGS='
    ...
    <setting label="$ADDON[pvr.iptvsimple 30042] @SRC@" type="lsep" visible="gt(@POS@,@COUNT@)"/>
    <setting type="sep" visible="gt(@POS@,@COUNT@)"/>

    <!-- Channels list -->
    <setting label="30043" type="lsep" visible="gt(@POS@,@COUNT@)"/> 
    ...
    <setting id="groupNameFormat_@SRC@" type="text" label="30044" default="%s" visible="gt(@POS@,@COUNT@)"/>
    <setting id="channelNameFormat_@SRC@" type="text" label="30045" default="%s" visible="gt(@POS@,@COUNT@)"/>
    ...
    <setting id="logoFileNameFormat_@SRC@" type="text" label="30046" default="%s" visible="gt(@POS@,@COUNT@)"/>
